...
public class DataManager implements Listener {
    ...
    private class LocalPlayerDataAccess extends AbstractBungeeDataAccess<ProxiedPlayer> {
        ...
        LocalPlayerDataAccess(Plugin plugin, Logger logger) {
            ...
            // SpaceDelta
            if (ProxyServer.getInstance().getPluginManager().getPlugin("Tony") != null) {
                addProvider(BTLPBungeeDataKeys.DATA_KEY_RedisBungee_ServerId, player -> TonyPlugin.INSTANCE.getLibrary().getEnvironment().getInstanceId());
            }
        }
    }
